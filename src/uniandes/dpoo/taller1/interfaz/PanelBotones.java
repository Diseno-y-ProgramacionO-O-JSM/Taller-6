...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	private final static String ELIMINAR_LIBRO = "EliminarLibro";
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(RENOMBRAR_CATEGORIA, "Renombrar categoria", "./data/iconos/switch.png");
		agregarBoton(ELIMINAR_LIBRO, "Eliminar libro", "./data/iconos/file-broken.png");
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			try {
				ventana.fuRenombrarCategoria();
			} catch (Exception e1) {
				String mensaje = "Ya existe una categor�a con ese nombre";
				JOptionPane.showMessageDialog(this, mensaje, "ERROR", JOptionPane.INFORMATION_MESSAGE);
				
			}
		}
		else if (ELIMINAR_LIBRO.equals(comando))
		{
			try {
				ventana.fuEliminarLibro();
			} catch (Exception e1) {
